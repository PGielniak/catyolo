...
class RedZone:
    ...
    # Stored as JSON in scenes.red_zones; round-trips as list[list[int]]
    # (JSON has no tuples). Typed to match the on-the-wire/storage shape so
    # Pydantic serialization does not warn on the lists-from-JSON values.
